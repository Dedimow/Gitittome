...
#initialize a variable for the source path selected in the GUI
sourceloc = Path(UtilityGUI.sourceloc)

#initialize a variable for the destination path selected in the GUI
destloc = Path(UtilityGUI.destloc)
...
def copier():
    ...
    for TLDump, FolderNames, TLVideos in os.walk(destloc):
    ...
    #     2. A list of strings in the current folder
    #     3. A list of strings of the files in the current folder  
    for SkyStudio, DateFolders, VideoFiles in os.walk(sourceloc):
